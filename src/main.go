...
func main() {
	...
	mux.HandleFunc("/certain/certain-delete", web.CertainDeleteHandler)
	mux.HandleFunc("/certain/certain-update", web.CertainUpdateHandler)

	// sub functions for Index
	mux.HandleFunc("/index/update", web.SubIndexUpdate)
